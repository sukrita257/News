...
@Component({
  selector: 'app-trending-left',
  templateUrl: './trending-left.component.html',
  styleUrls: ['./trending-left.component.css']
})
export class TrendingLeftComponent implements OnInit {
